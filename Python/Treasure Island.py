...
if  waitOrSwim == "wait":
    door3 = input("You arrive at the island unharmed. There is a house with 3 doors. One red, one yellow and one blue. Which colour do you choose?\n")
else:
...
if door3 == "red":
    ...
    print("You Chose a Door That Do Not Exists. Game Over!")
